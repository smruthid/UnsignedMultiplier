...
HD_PWD='C:/Vivado/unsignedmultiplierLab4Part1/unsignedmultiplierLab4Part1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unsigned_int_multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unsigned_int_multiplier.tcl
